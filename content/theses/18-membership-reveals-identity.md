---
title: Membership is itself the sensitive datum.
slug: membership-reveals-identity
number: 18
weight: 18
part: PART TWO — THE GRID
summary: The disclosure is not only what you said. It is that you were there.
description: Norway's data protection authority fined Grindr NOK 65 million in December
  2021 for sharing user data with advertising partners without valid consent, upheld
  on appeal in 2023 and by the Norwegian courts in October 2025.
draft: false
traits:
- label: FINE
  value: NOK 65M
  detail: Administrative privacy penalty imposed in Norway
- label: DECISION
  value: Dec 2021
  detail: Date of the Norwegian regulatory decision
- label: APPEAL
  value: Upheld
  detail: Penalty survived the company’s subsequent appeals
...
Norway's data protection authority fined Grindr NOK 65 million in December 2021 for sharing user data with advertising partners without valid consent, upheld on appeal in 2023 and by the Norwegian courts in October 2025.
